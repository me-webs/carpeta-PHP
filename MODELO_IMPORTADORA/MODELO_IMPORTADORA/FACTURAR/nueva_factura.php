			...
			<form class="form-horizontal" role="form" id="datos_factura">
				<div class="form-group row">
				  ...
				  <div class="col-md-3">
                      ...
                      <!--<select class="form-control input-sm"  id="id_cliente" id="nombre_cliente">
							<?php /*?><?php 
						...
						<div class="form-group row">
							...
							<div class="col-md-3">
								<select class='form-control input-sm' id="condiciones">
									...
									<option value="2">Mercadopagos</option>
									<option value="3">Débito</option>
									<option value="4">Crédito</option>
                                    <option value="5" >Abitab</option>
                                    <option value="6" >Brou</option>
								</select>
							</div>
                            </div>
							...
							<label for="email2" class="col-md-1 control-label">Canal</label>
							<div class="col-md-3">
								<select class='form-control input-sm' id="condiciones2">
									<option value="1">MERCADOLIBRE</option>
				...
				<div class="col-md-12">
					<div class="pull-right">
						...
						<button type="submit" class="btn btn-default">
						  <span class="glyphicon glyphicon-print"></span> ENTER
						</button>
					</div>	
				</div>
			</form>	
