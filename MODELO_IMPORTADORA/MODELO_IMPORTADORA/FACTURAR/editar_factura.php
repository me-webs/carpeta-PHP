<?php
	...
	$active_clientes="";
	$active_usuarios="";	
	$title="Editar Factura | CADETERÍA";
	...
	if (isset($_GET['id_factura']))
	{
		...
		$campos="clientes.id_cliente, clientes.nombre_cliente, clientes.telefono_cliente, clientes.email_cliente, facturas.id_vendedor, facturas.fecha_factura, facturas.condiciones, facturas.estado_factura, facturas.numero_factura, facturas.canal";
						...
						<div class="form-group row">
							...
							<div class="col-md-2">
								<select class='form-control input-sm ' id="condiciones" name="condiciones">
									...
									<option value="2" <?php if ($condiciones==2){echo "selected";}?>>Mercadopagos</option>
									<option value="3" <?php if ($condiciones==3){echo "selected";}?>>Débito</option>
									<option value="4" <?php if ($condiciones==4){echo "selected";}?>>Crédito</option>
                                    <option value="5" <?php if ($condiciones==5){echo "selected";}?>>Abitab</option>
                                    <option value="6" <?php if ($condiciones==6){echo "selected";}?>>Brou</option>
								</select>
							</div>
							<div class="col-md-2">
							...
							<label for="email" class="col-md-1 control-label">Canal</label>
							<div class="col-md-2">
								<select class='form-control input-sm ' id="condiciones2" name="condiciones2">
									<option value="1" <?php if ($condiciones2==1){echo "selected";}?>>MERCADOLIBRE</option>
									<option value="2" <?php if ($condiciones2==2){echo "selected";}?>>LOCAL</option>
									<option value="3" <?php if ($condiciones2==3){echo "selected";}?>>FACEBOOK</option>
									<option value="4" <?php if ($condiciones2==4){echo "selected";}?>>INSTAGRAM</option>
                                    <option value="5" <?php if ($condiciones2==5){echo "selected";}?>>WEB</option>
									<option value="6" <?php if ($condiciones2==6){echo "selected";}?>>OTROS</option>
				...
				<div class="col-md-12">
					<div class="pull-right">
						<button type="submit" class="btn btn-default">
						  <span class="glyphicon glyphicon-refresh"></span> Actualizar datos/stock
						</button>
