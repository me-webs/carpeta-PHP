...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    class HTML2PDF
    {
         ...
         */
        public function __construct($orientation = 'P', $format = 'Letter', $langue='es', $unicode=true, $encoding='UTF-8', $marges = array(0, 0, 0, 0))
        {
         ...
         * @return null
         */
        public function createIndex($titre = 'Index', $sizeTitle = 12, $sizeBookmark = 12, $bookmarkTitle = true, $displayPage = true, $onPage = null, $fontName = 'helvetica')
        {
