...
<?php
	...
	$total_iva2=number_format($total_iva,2,'.','');
	$total_factura=$subtotal+$total_iva2;
	$update=mysqli_query($con,"update facturas set total_venta='$total_factura' where id_factura='$id_factura'");

		
		
		// DOY DE BAJA PRODUCTO *********************************
		$sql2=mysqli_query($con, "select * from products, facturas, detalle_factura where facturas.numero_factura=detalle_factura.numero_factura and  facturas.id_factura='$id_factura' and products.id_producto=detalle_factura.id_producto");
...
<tr>
	...
	<td class='text-right'><?php echo number_format($total_iva2,2);?></td>
	<td></td>
</tr>
<tr>
