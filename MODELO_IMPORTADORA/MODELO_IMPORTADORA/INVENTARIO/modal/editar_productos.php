	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-edit'></i> Editar Envío</h4>
		  </div>
		  <div class="modal-body">
			...
			<div id="resultados_ajax2"></div>
             ...
             <div class="form-group">
				<label for="mod_talle" class="col-sm-3 control-label">Talle</label>
				<div class="col-sm-8">
					<select class='form-control' name='mod_talle' id='mod_talle' required>
            ...
            <div class="form-group">
				...
				<div class="col-sm-8">
				  <textarea class="form-control" id="mod_modelo" name="mod_modelo" placeholder="Modelo del producto" ></textarea>
				</div>
			  </div>
            ...
            <div class="form-group">
				...
				<div class="col-sm-8">
				  <textarea class="form-control" id="mod_detalle" name="mod_detalle" placeholder="Detalle del producto" ></textarea>
				</div>
			  </div>
              ...
              <div class="form-group">
				<label for="mod_codigo_barras" class="col-sm-3 control-label">Código Barras</label>
				<div class="col-sm-8">
				  <textarea class="form-control" id="mod_codigo_barras" name="mod_codigo_barras" placeholder="Código Barras" ></textarea>
				</div>
			  </div>
              
               <div class="form-group">
				<label for="mod_img" class="col-sm-3 control-label">Ruta img</label>
				<div class="col-sm-8">
				  <textarea class="form-control" id="mod_img" name="mod_img" placeholder="Ruta IMG" ></textarea>
				</div>
			  </div>
