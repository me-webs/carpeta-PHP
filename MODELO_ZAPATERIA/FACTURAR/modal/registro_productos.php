		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax_productos"></div>
              ...
              <div class="form-group">
				<label for="categoria" class="col-sm-3 control-label">Color</label>
				<div class="col-sm-8">
              ...
              <div class="form-group">
				...
				<div class="col-sm-8">
					<textarea class="form-control" id="modelo" name="modelo" placeholder="Modelo del producto"  maxlength="50" ></textarea>
              ...
              <div class="form-group">
				...
				<div class="col-sm-8">
					<textarea class="form-control" id="codigo_barras" name="codigo_barras" placeholder="Código del producto"  maxlength="50" ></textarea>
