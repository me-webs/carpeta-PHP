...
<?php
	...
	$sumador_total+=$precio_total_r;//Sumador
		...
		<tr>
			...
			<td class='text-center'><a href="#" onclick="eliminar('<?php echo $id_tmp ?>' <?php
	...
	$total_iva2=number_format($total_iva,0,'.','');
...
<tr>
	...
	<td class='text-right'><?php echo number_format($total_iva2,0);?></td>
	<td></td>
</tr>
<tr>
