<?php
	...
	$active_clientes="";
	$active_usuarios="";	
	$active_reporte_cobrado="active";
	$title="Reporte | ZAPATERÍA";
?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
<div class="container">
	...
	<h4><i class='glyphicon glyphicon-search'></i> Gestión para cobro </h4>
    ...
    $query=mysqli_query($con, "select YEAR(fecha_factura), MONTH(fecha_factura), COUNT(id_factura), SUM(total_venta) 
    	FROM facturas WHERE 
        estado_factura ='1' AND 
        fecha_factura BETWEEN '2018-01-01 00:00:00.000' AND '2100-12-31 00:00:00.000' GROUP BY MONTH(fecha_factura) ORDER BY YEAR(fecha_factura) DESC, MONTH(fecha_factura) DESC");
    ...
    while($fila=mysqli_fetch_row($query)){
        ...
        WHERE 
        estado_factura ='1' AND 
        fecha_factura BETWEEN '2020-01-01 00:00:00.000' AND '2100-12-31 00:00:00.000' ");
