	...
	<div class="panel panel-info">
		<div class="panel-heading">
		    <div class="btn-group pull-right">
				<button type='button' class="btn btn-info" data-toggle="modal" data-target="#nuevoProducto"><span class="glyphicon glyphicon-plus" ></span> Nuevo Artículo</button>
			</div>
			<h4><i class='glyphicon glyphicon-search'></i> Buscar Artículos</h4>
		</div>
