...
<html lang="en">
  ...
  <body>
	...
	if(empty($row['img'])){
	$img='https://f2fc7bc6-a-62cb3a1a-s-sites.googlegroups.com/site/zapateriadisenoweb/modelozapato_stock_001.jpg?attachauth=ANoY7copUTBzAMrrPtWDCqB1-tk3zBr-_RKd7lrbGN71POX_8SLmePyW6QbnmLKmc_SOXycX0gzY4t838Mk3XwbpG2ntguOgJ5GTF-uLvhzt9e76cLviU8gVNM89sk2V3lOGqDcENSO4Pd-oBgAlj43wsfG3giqTES9MT2EpBpSS26LKJDVRrlOyfmuOSNgnZKSuuMzpdCu4BDdqL7xRBA3wH5WiTK8wLMGdpVbSuXaY_kBbO4CPeiE%3D&attredirects=0';
	}else{
	$img=$row['img'];
	}
            ...
            <div class="row">
              ...
              <div class="col-sm-4 text-left">
                <div class="row margin-btm-20">
                    ...
                    <!-- TALLE  -->
					<div class="col-sm-12">
                      <span class="current-stock"> Talle  </span>
                    </div>
					<div class="col-sm-12">
